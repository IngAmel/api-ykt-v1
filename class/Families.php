...
class Families extends DataConn
{
    ...
    public function getAllDadsActives()
    {
        $result = null;
    ...
    public function getAllMomsActives()
    {
        $result = null;
    ...
    public function getAllStudentsActives()
    {
        $result = null;
    ...
    public function getRouteSupervisors()
    {
        $result = null;
        ...
        $stmt = $this->conn->prepare("SELECT t1.no_colaborador AS collaborator_number, CONCAT(t1.apellido_paterno_colaborador, ' ', t1.apellido_materno_colaborador, ' ', t1.nombres_colaborador) AS collaborator_name,
                                             t1.correo_institucional AS institutional_mail, t1.collab_institutional_mail_hash AS mail_institutional, t2.access_password AS password
    ...
    public function getDebtorFamilies()
    {
        $result = null;
